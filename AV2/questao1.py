...
# Caminho do arquivo
file_path = r"C:\Users\vitor\Downloads\IA.BLACK\IA--SI\AV2\star_classification.csv"
...
df.to_csv(r"C:\Users\vitor\Downloads\IA.BLACK\IA--SI\AV2\star_classification_processado.csv", index=False)
